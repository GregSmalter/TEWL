...
namespace Tewl.Tools {
	...
	public static class DoubleTools {
		...
		/// </summary>
		public static int RoundToHundred( this double val, MidpointRounding m ) => (int)Math.Round( val / 100d, m ) * 100;

		/// <summary>
		/// Rounds double value to nearest ten integer.
		/// 'Nearest' defined by the passed MidpointRounding
		/// </summary>
		public static int RoundToTen( this double val, MidpointRounding m ) => (int)Math.Round( val / 10d, m ) * 10;
		...
		/// </summary>
		public static string ToMoneyString( this double d ) => d.ToString( "c2" );
	}
}